...
public class ProductService
{
    ...
    public Product updateProduct(Long productId, Product updatedProduct)
    {
        ...
        oldProduct.setCategory( updatedProduct.getCategory()!=null ? updatedProduct.getCategory() : oldProduct.getCategory() );
        oldProduct.setPrice( updatedProduct.getPrice()!=null  ? updatedProduct.getPrice() : oldProduct.getPrice() );
        oldProduct.setStockQuantity( updatedProduct.getStockQuantity()!= oldProduct.getStockQuantity() ? updatedProduct.getStockQuantity() : oldProduct.getStockQuantity() );
